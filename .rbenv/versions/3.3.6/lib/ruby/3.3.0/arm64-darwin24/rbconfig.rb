...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/srinivasch/.rbenv/versions/3.3.6")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/srinivasch/.rbenv/versions/3.3.6' '--with-openssl-dir=/opt/homebrew/opt/openssl@3' '--enable-shared' '--with-libyaml-dir=/opt/homebrew/opt/libyaml' '--with-ext=openssl,psych,+' 'CC=clang'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/srinivasch/.rbenv/versions/3.3.6"
  ...
  CONFIG["host"] = "$(target)"
  CONFIG["build_os"] = "darwin24.0.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "aarch64"
  CONFIG["build"] = "aarch64-apple-darwin24.0.0"
