    ...
    <>
      ...
      <div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-gray-500 mb-6">{subject.department} - Start Year: {subject.startYear}</p>
          
          <h3 className="font-bold text-lg mb-4">Enrolled Students (Click a student to view their calendar)</h3>
          <div className="overflow-x-auto">
            ...
            {enrolledStudents.length === 0 && (
              <p className="text-center p-6 text-gray-500">No students are currently enrolled in this subject.</p>
            )}
          </div>
        </div>
      </div>
